...
export function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        // Basic mock authentication logic meter la logica del jwt ajustarla
        const user = users.find(u => u.email === email && u.password === password);

        if (user) {
            {/* Guardamos el nombre del usuario en localStorage para usarlos en dashboard */ }
    ...
    return (
        <div className="font-display bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-[80vh] flex items-center justify-center p-4">
            ...
            <main className="w-full max-w-[400px] flex flex-col items-center">
                ...
                {/* Login Card */}
                <div className="">
                    <div className="w-full bg-white dark:bg-slate-900/50 backdrop-blur-xl border border-slate-200 rounded-xl shadow-2xl p-8 ">
                        ...
                        <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 flex flex-col items-center gap-3">
                            ...
                            <p className="text-[11px] text-slate-400 dark:text-slate-500 text-center leading-relaxed max-w-[240px]">
                                Credenciales y datos de sesión protegidos
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="fixed top-0 left-0 w-full h-full overflow-hidden opacity-40 dark:opacity-20 pointer-events-none">
